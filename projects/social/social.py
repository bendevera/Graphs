...
if __name__ == '__main__':
    ...
    for i in range(1, 1001):
        ...
        connection_sum += (len(connections) -1) / 1000 * 100
        curr_average_length = 0
        for user_id, path in connections.items():
            curr_average_length += len(path)
        average_length_sum += (curr_average_length / len(connections))
    print(connection_sum / 1000)
    print(average_length_sum / 1000)
